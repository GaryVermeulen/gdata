...
b4tagging = 'pickleJar/b4tagging.p'
...
def getRawCorpus():
    ...
    # Save a list of what was read
    print('Saving list of books read to pickle...')
    with open(booksRead, "wb") as f:
        pickle.dump(dirList, f)
        
    print('Input corpora/books read and list saved.')
...
def buildLex():
    ...
    with open(b4tagging, "wb") as f:
        pickle.dump(expandedCorpora, f)
        
    print('Saved: expandedCorpora to pickle.')
