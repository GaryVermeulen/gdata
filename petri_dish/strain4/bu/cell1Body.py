...
if __name__ == "__main__":
    ...
    while time.time() < end_time:
        ...
        print('Running: pid: {}; ppid: {}; DNA: {}; loopCnt: {}; startNum: {}; currentNum: {}'.format(pid, ppid, dnaFile, loopCnt, startNum, currentNum))

        # Principal cell functions
        res = dna.isNumPrime1(currentNum) # CurrentNum prime?        
        print("isNumPrime1: ", res)

        # Write to log
        writeLog('pid:' + str(pid) + ',ppid:' + str(ppid) + ',DNA:' + str(dnaFile) + ',loopCnt:' + str(loopCnt) + ',startNum:' + str(startNum) + ',currentNum:' + str(currentNum) + ",isPrime:" + str(res) + "\n")
