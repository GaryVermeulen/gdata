...
#                print('a not in variables: ', a)
                return False
#        else:
#            print('else a not in [(, ), AND, OR, NOT]: ', a)
    
    if consequent not in variables or variables[consequent].get_root():
#        print('-' * 10)
#        print(' consequent not in variables: ', consequent)
#        print(type(variables))
#        print(' variables: ', variables)
#        print(' variables[consequent].get_root(): ', variables[consequent].get_root())
#        
        return False
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if teach_var:
            ...
            # Mod: Let's allow variable redefinition
            #for key in var_list:
            #    if key == args[2]:
