...
soup1 = soup.find(class_="important-blue-link")
...
# Print short meaning
print ('-' * 25 + '->',word,"<-" + "-" * 25)
print ("import-blue-link: \n\n",soup1)
print ('-' * 65)

results = soup.find(class_="sense no-subnum")
#meta_description = results.find_all("meta", name_="description")
