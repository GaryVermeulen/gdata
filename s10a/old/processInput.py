...
#        quit() # Closes the interpreter
    ...
    print('-' * 5)
    #
    # We'll come back to thios later...
    #
    #validTaggedInput, diff, intr = validInput(taggedInput, taggedBoW)  # Is the input in out list?

#    print('len valid_uI: ', len(valid_uI))
#    print('type valid_uI: ', type(valid_uI))
#    for v in valid_uI:
#        print(v)
#    print('valid_uI: ', validTaggedInput)
#    print('diff: ', diff)
#    print('intr: ', intr)
#    print('-' * 5)
    """
    ...
    print('-' * 10)
    """
#    tagged_uI = tagSentence(uI, newWords, taggedBoW) No longer needed...~?!
