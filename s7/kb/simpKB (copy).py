#
# simpKB.py -- Dynamic KB constructed by updateKB.py
#
...
class Park(ThingMaker):

    def createThing(self, whichThing):
        chooser ={
            "playground": playGoundParkRecreation_groundThing()
        }
        return chooser.get(whichThing)

class Bird(ThingMaker):

    def createThing(self, whichThing):
        chooser ={
            "duck": duckBirdAnimalThing()
        }
        return chooser.get(whichThing)

class Mammal(ThingMaker):

    def createThing(self, whichThing):
        chooser ={
            "canine": canineMammalAnimalThing(),
            "feline": felineMammalAnimalThing(),
            "human": humanMammalAnimalThing()
        }
        return chooser.get(whichThing)
...
class Canine(ThingMaker):

    def createThing(self, whichThing):
        chooser = {
            "dog": canineMammalAnimalThing()
        }
        return chooser.get(whichThing)
...
class Human(ThingMaker):
    ...
    def createThing(self, whichThing):
        chooser = {
            ...
            "woman": humanMammalAnimalThing(),
            "self": humanMammalAnimalThing()
        }
        return chooser.get(whichThing)
